...
<div class="page-header">
  <div class="page-header-left"><h1>Modifier {{ $article->name }}</h1><p>Les niveaux de stock se pilotent via mouvements et BL, pas par edition directe.</p></div>
...
<div class="row" style="align-items:flex-start;">
  <div class="col-8" style="padding:0 12px 0 0;">
    ...
    <div class="form-section">
      <h3 class="form-section-title"><i class="fas fa-warehouse"></i> Stock pilote</h3>
      <div class="row">
        <div class="col-6"><div class="form-group"><label class="form-label">Stock courant</label><input type="text" class="form-control" value="{{ $article->current_stock }}" readonly></div></div>
      ...
      <p style="margin:0;color:var(--c-ink-40);font-size:12px;">Pour modifier le stock, utilisez un BL d'entree, un BL de sortie ou un futur ajustement de stock.</p>
    </div>
