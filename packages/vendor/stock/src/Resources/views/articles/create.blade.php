...
<div class="page-header">
  <div class="page-header-left"><h1>Nouvel article</h1><p>Ajoutez un article a votre catalogue. Le stock initial generera un mouvement d'ouverture.</p></div>
...
<div class="row" style="align-items:flex-start;">
  <div class="col-8" style="padding:0 12px 0 0;">
    <div class="form-section">
      <h3 class="form-section-title"><i class="fas fa-box"></i> Informations generales</h3>
      <div class="row">
    ...
    <div class="form-section">
      <h3 class="form-section-title"><i class="fas fa-warehouse"></i> Stock de depart</h3>
      <div class="row">
        <div class="col-6"><div class="form-group"><label class="form-label">Stock initial</label><input type="number" step="any" min="0" name="opening_stock" class="form-control" value="0"></div></div>
      ...
      <p style="margin:0;color:var(--c-ink-40);font-size:12px;">Le stock initial est converti en mouvement d'ouverture pour garder une tracabilite complete.</p>
    </div>
  ...
  <div class="col-4" style="padding:0 0 0 12px;">
    <div class="form-section" style="margin-bottom:16px;">
      <h3 class="form-section-title"><i class="fas fa-tags"></i> Prix</h3>
